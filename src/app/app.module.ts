...
@NgModule({
  ...
  providers: [{ provide: RouteReuseStrategy, useClass: IonicRouteStrategy },Globalization,Camera,Network,Chooser,Device,FileTransfer,FilePath,AndroidPermissions,LocalNotifications,StatusBar,SQLite,File,BackgroundMode],
